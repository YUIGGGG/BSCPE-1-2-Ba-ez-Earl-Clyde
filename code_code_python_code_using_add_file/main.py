...
if __name__ == "__main__":
    _num = "00986276038"
    _carrier = "globe"
    _email = "earlclyde197975@gmail.com"  # Your Gmail address
    _pword = "your_password"  # Your Gmail password
    _msg = "Your message here"  # Message you want to send
    _subj = "Optional subject"  # Optional: Subject of the email
